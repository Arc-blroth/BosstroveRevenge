//! Constant definitions of types used throughout the JNI code.
...
pub const VECTOR2D_CLASS: &str = "org/joml/Vector2d";
pub const VECTOR2F_CLASS: &str = "org/joml/Vector2f";
pub const VECTOR3D_CLASS: &str = "org/joml/Vector3d";
...
pub const COLOR_CLASS: &str = "ai/arcblroth/boss/util/Color";
pub const CAMERA_CLASS: &str = "ai/arcblroth/boss/render/Camera";
...
pub const RENDERER_SETTINGS_CLASS: &str = "ai/arcblroth/boss/backend/RendererSettings";
pub const FULLSCREEN_MODE_CLASS: &str = "ai/arcblroth/boss/backend/RendererSettings$FullscreenMode";
pub const BOUNDS_CLASS: &str = "ai/arcblroth/boss/backend/ui/Bounds";
pub const TEXT_STYLE_CLASS: &str = "ai/arcblroth/boss/backend/ui/TextStyle";
pub const LABEL_CLASS: &str = "ai/arcblroth/boss/backend/ui/Label";
...
pub const ROAST_AREA_CLASS: &str = "ai/arcblroth/boss/roast/RoastArea";
