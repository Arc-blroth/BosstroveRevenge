...
public class FloorTileRegistry {
	...
	public void register(String key, Texture tileTexture, Hitbox hitbox, TriFunction<Room, TilePosition, JsonObject, FloorTile> builder) {
		map.put(key, new FloorTileBuilder(tileTexture, hitbox) {
	...
	public void register(String key, Texture tileTexture, Hitbox hitbox, BiFunction<Room, TilePosition, FloorTile> builder) {
		map.put(key, new FloorTileBuilder(tileTexture, hitbox) {
			public FloorTile build(Room room, TilePosition tilePos, JsonObject context) {
